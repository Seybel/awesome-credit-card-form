    ...
    <div class="card-item__side -front">
      ...
      <div class="card-item__wrapper">
        <div class="card-item__top">
          <img
            src="https://raw.githubusercontent.com/seybel/awesome-credit-card-form/main/src/assets/images/chip.png"
  ...
  computed: {
    ...
    currentCardBackground() {
      if (this.randomBackgrounds && !this.backgroundImage) {
        ...
        return `https://raw.githubusercontent.com/seybel/awesome-credit-card-form/main/src/assets/images/${random}.jpeg`;
